...
// userId present → public read-only (no create / delete, drill-in is read-only).
// userId absent  → own profile with full CRUD (original behaviour).
export default function ListsTab({ userId }) {
  ...
  // When drilling into a public list, fetch the full detail first
